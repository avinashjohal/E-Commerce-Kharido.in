          ...
          <div className="row">
            ...
            <div className="col-6">
              <p className="text-end text-white mb-0">
                HotLine:
                <a className="text-white" href="tel:+91 8950371540">
                  &nbsp;
                  +91 &nbsp;8950371540
                </a>
              </p>
      ...
      <header className="header-upper py-2">
        <div className="container-xxl">
          <div className="row align-items-center">
            <div className="col-2">
              <h3>
                <Link to="/"className="text-white ">Khrido.<small>in</small></Link>
              </h3>
            </div>
            <div className="col-5">
              ...
              <div className="header-upper-links d-flex align-items-center justify-content-between">
                ...
                <div>
                  <Link to="/login" className="d-flex align-items-center gap-10 text-white">
                    <img src="/images/user.svg" alt="user Account" />
                ...
                <div>
                  <div className="dropdown">
                    <button
                      ...
                      aria-expanded="false"
                    >
                      <img className="gap-15 me-10" src="/images/menu.svg" alt="categories" />
